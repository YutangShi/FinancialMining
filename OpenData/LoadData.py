...
def StockPrice(stock = [],load_all = False,datalist = False):
...
def FinancialStatements(stock = [],load_all = False,datalist = False):
...
def StockDividend(stock = [],load_all = False,datalist = False):
...
def ExchangeRate(country = [],load_all = False,datalist = False):
...
def InterestRate(country = [],load_all = False,datalist = False):
